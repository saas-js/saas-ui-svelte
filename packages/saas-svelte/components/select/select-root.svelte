<script module lang="ts">
	...
	export const select = tv({
		slots: {
			root: ["flex", "flex-col", "gap-y-1.5", "gap-x-1.5", "w-full"],
			label: [
				"select-none",
				"font-medium",
				"text-fg-default",
		...
		variants: {
			size: {
				xs: {
					...
					trigger: "min-h-6 text-xs leading-xs px-2 gap-x-1 gap-y-1",
					...
					clearTrigger: "w-5 h-5",
				},
				sm: {
					label: "text-sm leading-sm",
					trigger:
						"min-h-7 text-sm leading-sm px-2.5 gap-x-1 gap-y-1",
					content: "text-sm leading-sm p-1",
					item: "text-sm leading-sm px-1.5 py-1",
					itemIndicator: "w-3.5 h-3.5",
					itemGroupLabel: "text-sm leading-sm px-1.5 py-1",
					indicator: "w-4 h-4",
					clearTrigger: "w-6 h-6",
				},
				md: {
					label: "text-sm leading-sm",
					trigger: "min-h-8 text-sm leading-sm px-3 gap-x-2 gap-y-2",
					content: "text-sm leading-sm p-1",
				...
				lg: {
					label: "text-sm leading-sm",
					trigger:
						"min-h-10 text-md leading-md px-3.5 gap-x-2 gap-y-2",
