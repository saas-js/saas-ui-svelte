	...
	export const steps = tv({
		...
		compoundVariants: [
			// Vertical separator positioning per size (center under indicator)
			{
				...
				class: {
					separator:
						"mx-0 left-[calc(1rem-1px)] max-h-[calc(100%-3rem)]",
				},
			},
			{
				orientation: "vertical",
				...
				class: {
					separator:
						"mx-0 left-[calc(1.25rem-1px)] max-h-[calc(100%-4rem)]",
				},
			},
			{
				orientation: "vertical",
				...
				class: {
					separator:
						"mx-0 left-[calc(1.375rem-1px)] max-h-[calc(100%-4.5rem)]",
				},
			},
		],
		defaultVariants: {
