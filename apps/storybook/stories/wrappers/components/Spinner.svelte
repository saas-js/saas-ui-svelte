<script lang="ts" module>
	// Wrapper components for complex Spinner stories
	// These are imported by Spinner.stories.ts for stories that need loops/snippets
</script>
