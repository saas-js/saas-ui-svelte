		...
		subComponents: [
			{
				...
				props: {
					children: {
						type: "Snippet",
						default: "-",
						description: "Content to render inside the accordion (composition API).",
					},
					items: {
						type: "AccordionItem[]",
						default: "-",
					...
					defaultValue: {
						type: "string[]",
						default: "-",
						description: "The default value(s) of the accordion items to open.",
					},
					id: {
						type: "string",
						default: "-",
						description: "Unique identifier for the accordion. Required for accessibility.",
					},
					size: {
						type: '"sm" | "md" | "lg"',
						default: '"md"',
			...
			{
				name: "AccordionItem",
				description: "A single accordion item containing a trigger and content.",
				props: {
					children: {
						type: "Snippet",
						default: "-",
						description: "The content of the accordion item (trigger and content).",
					},
					value: {
						type: "string",
						default: "-",
			...
			},
			{
				...
				description: "The collapsible content section of an accordion item.",
				props: {
					children: {
						type: "Snippet",
						default: "-",
