...
<Flex
	class="border-border-default bg-bg-muted h-100 md:h-150 w-full max-w-360 overflow-hidden rounded-md border xl:max-w-400"
>
	...
	<Flex
		class="border-border-default w-full lg:w-64 flex-1 shrink-0 overflow-hidden lg:border-r {mobileShowEmail ? 'hidden lg:flex' : 'flex'}"
	>
		<EmailList
	...
	<div class="{mobileShowEmail ? 'flex' : 'hidden'} lg:flex flex-1">
